...
<template>
  <main
    class="min-h-screen bg-[radial-gradient(circle_at_15%_20%,#554533,transparent_40%),radial-gradient(circle_at_85%_0%,#76440f,transparent_28%),linear-gradient(160deg,#170d02,#2a210f,#272111)] px-4 py-8 text-slate-100 sm:px-6 lg:px-8"
  >
    <div class="mx-auto max-w-7xl">
      <header class="mb-8">
        <p class="text-xs font-semibold tracking-[0.3em] text-amber-300/90 uppercase">Project #4</p>
          ...
          >
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              ...
              <button
                ...
                class="cursor-pointer rounded-full border border-amber-300/70 bg-amber-400/20 px-6 py-3 text-base font-black tracking-wide text-amber-100 hover:bg-amber-400/30 disabled:cursor-not-allowed disabled:opacity-60"
                @click="spin"
              >
                {{ spinLabel }}
              </button>
